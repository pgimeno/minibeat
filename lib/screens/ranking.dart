                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return GestureDetector(
                            onTap: () async{
                              Player? tappedPlayer = await getPlayerTapped(snapshot.data![index].userName);
                              if(tappedPlayer!= null){
                                Navigator.pushNamed(context, '/puzzleFromOther',
                                    arguments: {'userLogged': tappedPlayer});
                              }
...
Future<Player?> getPlayerTapped(String playerName) async {
  Player? player = await checkUser(playerName);
